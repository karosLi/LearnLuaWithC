...
@implementation KKPDynamicBlock
...
- (ffi_type *)getffiTypeFromDyType:(NSString *)type
{
    if ([type isEqualToString:DyVoidType]) {
        ...
        NSArray* struct2des = kkp_parseStructFromTypeDescription(type);
...
{
    KKPDynamicBlock* dy = (__bridge KKPDynamicBlock*)userdata;
