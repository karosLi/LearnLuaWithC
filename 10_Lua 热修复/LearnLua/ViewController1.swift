...
class ViewController1: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        print("【原生】LearnLua.ViewController1 当前 title:\(self.title!)")
        print("【原生】LearnLua.ViewController1 当前 a:\(a)")
        print("【原生】LearnLua.ViewController1 当前 pa:\(pa)")
        
        doManyThing("写代码")
    }
    
    @objc dynamic func doManyThing(_ thingName: String) {
        print("【原生】LearnLua.ViewController1 thingName: \(thingName)")
    }
